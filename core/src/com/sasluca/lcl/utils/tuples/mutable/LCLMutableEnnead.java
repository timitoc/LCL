...
/**
 * A mutable ennead is a {@link LCLTuple tuple} that holds nine values which can be changed
 ...
 */
public class LCLMutableEnnead<A, B, C, D, E, F, G, H, I> extends LCLTuple
{
    /** Object is serializable */
    private static final long serialVersionUID = -6010691763749333273L;
    ...
    public LCLMutableEnnead(A value1, B value2, C value3, D value4, E value5, F value6, G value7, H value8, I value9)
    {
        m_Value1 = value1;
        m_Value2 = value2;
        m_Value3 = value3;
    ...
    public final <O extends A> LCLMutableEnnead<A, B, C, D, E, F, G, H, I> set1(O value) { m_Value1 = value; return this; }
    public final <O extends B> LCLMutableEnnead<A, B, C, D, E, F, G, H, I> set2(O value) { m_Value2 = value; return this; }
    public final <O extends C> LCLMutableEnnead<A, B, C, D, E, F, G, H, I> set3(O value) { m_Value3 = value; return this; }
    public final <O extends D> LCLMutableEnnead<A, B, C, D, E, F, G, H, I> set4(O value) { m_Value4 = value; return this; }
    public final <O extends E> LCLMutableEnnead<A, B, C, D, E, F, G, H, I> set5(O value) { m_Value5 = value; return this; }
    public final <O extends F> LCLMutableEnnead<A, B, C, D, E, F, G, H, I> set6(O value) { m_Value6 = value; return this; }
    public final <O extends G> LCLMutableEnnead<A, B, C, D, E, F, G, H, I> set7(O value) { m_Value7 = value; return this; }
    public final <O extends H> LCLMutableEnnead<A, B, C, D, E, F, G, H, I> set8(O value) { m_Value8 = value; return this; }
    public final <O extends I> LCLMutableEnnead<A, B, C, D, E, F, G, H, I> set9(O value) { m_Value9 = value; return this; }
