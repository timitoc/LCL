...
/**
 * A mutable quartet is a {@link LCLTuple tuple} that holds four values which can be changed
 ...
 */
public class LCLMutableQuartet<A, B, C, D> extends LCLTuple
{
    /** Object is serializable */
    private static final long serialVersionUID = 7802864749604065098L;
    ...
    public LCLMutableQuartet(A value1, B value2, C value3, D value4)
    {
        m_Value1 = value1;
        m_Value2 = value2;
        m_Value3 = value3;
    ...
    public final <O extends A> LCLMutableQuartet<A, B, C, D> set1(O value) { m_Value1 = value; return this; }
    public final <O extends B> LCLMutableQuartet<A, B, C, D> set2(O value) { m_Value2 = value; return this; }
    public final <O extends C> LCLMutableQuartet<A, B, C, D> set3(O value) { m_Value3 = value; return this; }
    public final <O extends D> LCLMutableQuartet<A, B, C, D> set4(O value) { m_Value4 = value; return this; }
