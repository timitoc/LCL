package com.sasluca.lcl.ui.material_design.lists.modellists.scrolllists;
...
import com.sasluca.lcl.ui.material_design.modelview.UIModelContainer;
import com.sasluca.lcl.ui.material_design.modelview.UIModelView;
...
public class UIModelVerticalList<Model, View extends UIModelView<Model, View>> extends UIView<UIModelVerticalList> implements IList<UIModelVerticalList<Model, View>, Model>, IDisposable
{
    ...
    @Override public UIModelVerticalList addItem(Model model)
    {
        UIModelContainer container = new UIModelContainer(model, m_Mask.getWidth(), m_ViewHeight + m_HeightPadding, false);
    ...
    {
        m_List.clear();
        for(int i = 0; i < m_Group.getNumberOfObjects(); i++) m_Group.removeObject(i);

        return this;
    }

    @Override public int getNumberOfItems() { return 0; }
    ...
    @Override public Model getItem(int id) { return (Model) m_List.get(id).getModel(); }

    @Override public void onUnsubscribeFromInputLayer()
    {
