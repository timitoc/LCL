...
public class UIVerticalList extends UIView<UIVerticalList> implements IMasking<UIVerticalList>, ISizeable<UIVerticalList>, IDisposable
{
    ...
    @Override protected void onUnsubscribeFromInputLayer(int oldLayer)
    {
    ...
    @Override public boolean isMaskingEnabled() { return false; }
    @Override public UIVerticalList setMasking(boolean masking) { return null; }
