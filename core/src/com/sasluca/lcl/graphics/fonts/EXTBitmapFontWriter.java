...
/**
 * External code, made by jrenner, can be found at https://github.com/jrenner/gdx-smart-font
 */
public class EXTBitmapFontWriter
{
    ...
    private static String quote(Object params, boolean spaceAfter) {
        if (EXTBitmapFontWriter.getOutputFormat() == OutputFormat.XML)
